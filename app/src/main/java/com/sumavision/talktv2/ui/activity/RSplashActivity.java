...
/**
 * Created by sharpay on 16-12-23.
 */
...
public class RSplashActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String adPlaceId = "af91a5f1"; // 重要：请填上您的广告位ID，代码位错误会导致无法请求到广告
    ...
    private void jumpWhenCanClick() {
        ...
        if (canJumpImmediately) {
            this.startActivity(new Intent(RSplashActivity.this, SplashActivity.class));
            this.finish();
        } else {
