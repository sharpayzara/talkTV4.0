...
public class AddCartAnimation {
    ...
    public static void AddToCart(final ImageView startView, View endView, Context mContext, final RelativeLayout rl, final int time) {
        ...
        ObjectAnimator oa2 = ObjectAnimator.ofFloat(view, "scaleY", 1f,2f);
        ObjectAnimator oa3 = ObjectAnimator.ofFloat(view, "scaleX", 1f,2f);
        AnimatorSet animSet = new AnimatorSet();
        animSet.play(oa).with(va).with(oa2).with(oa3);
        animSet.setDuration(time * 1000);
        animSet.start();
    }
}
